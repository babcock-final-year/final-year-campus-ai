...
# python -m unittest discover -s test -p "test_auth.py" -v
...
class AuthTestCase(unittest.TestCase):
    ...
    def test_register_invalid_email(self):
        ...
        response = self.client.post(
            "/api/v1/auth/register", data=json.dumps(invalid_user), content_type="application/json"
        )
        self.assertEqual(response.status_code, 422)

    def test_register_short_password(self):
        """Test registration with password < 8 characters."""
        invalid_user = {"full_name": "Test User", "email": "test@example.com", "password": "short"}
        response = self.client.post(
            "/api/v1/auth/register", data=json.dumps(invalid_user), content_type="application/json"
        )
        self.assertEqual(response.status_code, 422)
    ...
    def test_register_missing_fields(self):
        ...
        incomplete_user = {"email": "test@example.com", "password": "SecurePassword123"}
        response = self.client.post(
            "/api/v1/auth/register",
    ...
    def test_confirm_email_expired_token(self):
        ...
        self.client.get(f"/api/v1/auth/confirm/{expired_token}")
    ...
    def test_login_success(self):
        ...
        # Login
        login_data = {"email": self.valid_user["email"], "password": self.valid_user["password"]}
        response = self.client.post(
            "/api/v1/auth/login", data=json.dumps(login_data), content_type="application/json"
        )
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertIn("access_token", data)
    ...
    def test_login_invalid_password(self):
        ...
        login_data = {"email": self.valid_user["email"], "password": "WrongPassword123"}
        response = self.client.post(
            "/api/v1/auth/login", data=json.dumps(login_data), content_type="application/json"
        )
    ...
    def test_login_oauth_account_no_password(self):
        ...
        # Try to login
        login_data = {"email": "oauth@example.com", "password": "AnyPassword123"}
        response = self.client.post(
            "/api/v1/auth/login", data=json.dumps(login_data), content_type="application/json"
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_reset_password_confirm_success(self):
        ...
        login_data = {"email": self.valid_user["email"], "password": "NewSecurePassword123"}
        response = self.client.post(
            "/api/v1/auth/login", data=json.dumps(login_data), content_type="application/json"
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_change_email_invalid_password(self):
        ...
        change_email_data = {"new_email": "newemail@example.com", "password": "WrongPassword123"}
        response = self.client.post(
            "/api/v1/auth/change-email",
            data=json.dumps(change_email_data),
            content_type="application/json",
    ...
    def test_change_email_duplicate_email(self):
        ...
        login_response = self.client.post(
            "/api/v1/auth/login",
            data=json.dumps(
                {"email": self.valid_user["email"], "password": self.valid_user["password"]}
            ),
            content_type="application/json",
        )
        access_token = json.loads(login_response.data)["access_token"]
